  ...
  return (
    <div className="main2 flex">
      <div className="mx-12 grid place-content-around xl:w-[45%] xl:mx-auto">
        ...
        <form className="grid grid-cols-3 items-center gap-7">
          <input
            className="text col-span-2 reg-input"
            placeholder=".artificiul.app"
          />
          <Link to={"/access2"}>
            <button className="rounded-md log col-start-3 h-11">
              Join Workspace
            </button>
          </Link>
        </form>
        ...
        <Link to={'/access'}><button className="rounded-md wks p-2">
          Create free new workspace
        </button></Link>
